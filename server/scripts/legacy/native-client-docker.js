#!/usr/bin/env node
// Native client for Docker environment
// Connects to server via WebSocket and executes binaries
...
// Default to connecting to the server container
const serverHost = args.host || 'webgpu-volunteer-server';
