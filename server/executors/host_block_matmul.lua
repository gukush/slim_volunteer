...
function compile_and_run(chunk)
  ...
  print("[lua] Debug - fw: " .. tostring(fw) .. ", is_cuda_framework: " .. tostring(is_cuda_framework(fw)))
  print("[lua] Debug - task.grid: " .. tostring(task.grid) .. ", task.block: " .. tostring(task.block))
